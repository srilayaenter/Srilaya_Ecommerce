...
export default function ContactUsPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Connect your backend handler API endpoint logic here if desired
    setSubmitted(true);
  };
  ...
  return (
    <div className="bg-white min-h-screen text-slate-800">
      ...
      {/* 2. CONTACT DETAILS & FORM INTERACTIVE GRID */}
      <section className="py-16 container mx-auto px-4 max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-2 space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Reach Out To Us</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 text-sm">Our Processing Unit Address</h4>
                  <p className="text-slate-600 text-xs mt-1 leading-relaxed">
                    {BRAND.name} Organic Hub,<br />
                    Industrial Area, Hebbal,<br />
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 text-sm">Phone Support & WhatsApp</h4>
                  <p className="text-slate-600 text-xs mt-1 font-mono">+91 98765 43210</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 text-sm">Email Support Channels</h4>
                  <p className="text-slate-600 text-xs mt-1 font-mono">support@srilayamillets.com</p>
                </div>
              </div>
            </div>
          </div>

          {/* Right Column: Customer Message Form Wrapper */}
          <div className="md:col-span-3 bg-slate-50 border border-slate-200/60 p-6 md:p-8 rounded-2xl shadow-sm">
            {submitted ? (
              <div className="text-center py-12 bg-white rounded-xl border border-emerald-100 shadow-inner p-6">
                ...
                <h3 className="text-lg font-bold text-slate-900 mt-3">Message Sent Successfully!</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-wide mb-1.5">Your Message / Inquiry</label>
                  <textarea 
                    rows={4}
                    required
