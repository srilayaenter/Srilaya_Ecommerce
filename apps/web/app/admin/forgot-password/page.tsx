      ...
      <div className="bg-white rounded-[12px] border border-[#E0E0E0] shadow-[0_4px_12px_rgba(0,0,0,0.05)] w-full max-w-md p-8">
        {submitted ? (
          <div className="text-center py-4">
            <EnvelopeSimple size={40} weight="regular" className="text-naturals-green mx-auto mb-4" />
            ...
            <Link href="/admin/login" className="text-naturals-green font-bold text-sm hover:underline">
              ← Back to login
            </Link>
          </div>
        ) : (
          <>
            ...
            <div className="text-center mt-5">
              <Link href="/admin/login" className="text-[#8D6E63] text-sm hover:text-naturals-green transition-colors">
                ← Back to login
              </Link>
            </div>
          </>
