  ...
  if (!token) {
    return (
      <div className="text-center py-4">
        ...
        <p className="text-sm text-[#616161]">Ask an administrator to send you a new one.</p>
      </div>
    );
  }
    ...
    <>
      {success ? (
        <div className="text-center py-4">
          ...
          <h2 className="text-lg font-bold text-[#212121] mb-2">Account activated!</h2>
          <p className="text-sm text-[#616161]">Redirecting you to login…</p>
        </div>
      ) : (
        <>
          <p className="text-sm text-[#616161] mb-6">Set a password to activate your staff account.</p>
