    ...
    <div className="min-h-screen bg-[#F9F6F0] flex items-center justify-center px-4 py-12">
      ...
      <div className="max-w-lg w-full space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-[#E8E0D5] shadow-sm p-8 text-center">
          <div className="w-16 h-16 bg-naturals-green/10 rounded-full flex items-center justify-center mx-auto mb-4">
            <Scooter size={32} weight="regular" className="text-naturals-green" />
          </div>
          ...
          <div className="mt-4 bg-[#F5F5F5] rounded-xl px-4 py-3 inline-block">
            ...
            <p className="text-xl font-black text-naturals-green font-mono">#{shortId}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[#E8E0D5] shadow-sm p-6">
          ...
          <div className="border-t border-[#E0E0E0] mt-2 pt-3 flex justify-between font-black text-base">
            ...
            <span className="text-naturals-green">₹{toNum(order.total).toFixed(2)}</span>
          </div>
        </div>
        ...
        <div className="text-center space-y-3">
          <Link
            ...
            className="block w-full bg-naturals-green text-white font-bold py-3 rounded-xl text-sm hover:bg-naturals-green-dark transition-colors"
          >
            Track My Order
          </Link>
          <a
          ...
          <Link href="/product" className="block text-sm text-naturals-green font-bold hover:underline">
            Continue Shopping →
          </Link>
        </div>

        <p className="text-center text-xs text-[#9E9E9E]">
          Questions? Call <a href={`tel:${BRAND.phone}`} className="text-naturals-green font-bold">{BRAND.phone}</a>
        </p>
      </div>
    </div>
  );
