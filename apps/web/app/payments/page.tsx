      ...
      <section className="py-16 container mx-auto px-4 max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 text-center flex flex-col items-center">
            ...
            <h3 className="font-bold text-slate-900 text-base mb-2">UPI & Wallet</h3>
          ...
          <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 text-center flex flex-col items-center">
            ...
            <h3 className="font-bold text-slate-900 text-base mb-2">Cards & Banking</h3>
            <p className="text-slate-500 text-xs leading-relaxed">
          ...
          <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 text-center flex flex-col items-center">
            ...
            <h3 className="font-bold text-slate-900 text-base mb-2">Secure Gateway</h3>
            <p className="text-slate-500 text-xs leading-relaxed">
        ...
        {/* 3. DIRECT BANK TRANSFER INFORMATION BOX */}
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8 text-sm">
              ...
              <div className="flex justify-between py-2 border-b border-slate-100">
                ...
                <span className="font-bold text-slate-800 text-right">State Bank of India (SBI)</span>
              </div>
              <div className="flex justify-between py-2 border-b border-slate-100">
                <span className="text-slate-500 font-medium">Account Number</span>
                <span className="font-mono font-bold text-slate-800 text-right">XXXXXXXX9482</span>
              </div>
              <div className="flex justify-between py-2 border-b border-slate-100">
                <span className="text-slate-500 font-medium">IFSC Code</span>
                <span className="font-mono font-bold text-brand-green text-right">SBIN0040182</span>
              </div>
              <div className="flex justify-between py-2 border-b border-slate-100 sm:col-span-2">
                ...
                <span className="font-bold text-slate-800 text-right">Mysuru Main Branch, Karnataka</span>
              </div>
            </div>
