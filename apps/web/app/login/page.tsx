      ...
      <div className="bg-white rounded-[12px] border border-[#E0E0E0] shadow-[0_4px_12px_rgba(0,0,0,0.05)] w-full max-w-md p-8">
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      maxLength={10}
                      className="flex-1 border border-[#E0E0E0] rounded-r-[8px] px-4 py-3 focus:outline-none focus:border-naturals-green focus:ring-1 focus:ring-naturals-green text-[#212121] transition-all"
                    />
                  </div>
                </div>
                {error && <p className="text-red-600 text-sm font-medium">{error}</p>}
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-4">
                <p className="text-sm text-[#616161]">
                  ...
                  <button
                    ...
                    className="text-naturals-green font-bold hover:underline"
                  >
                    Change
                  </button>
                </p>
                <div>
                  ...
                  <input
                    ...
                    maxLength={6}
                    className="w-full border border-[#E0E0E0] rounded-[8px] px-4 py-3 focus:outline-none focus:border-naturals-green focus:ring-1 focus:ring-naturals-green text-[#212121] text-center text-2xl font-black tracking-[0.5em] transition-all"
                  />
                </div>
                {error && <p className="text-red-600 text-sm font-medium">{error}</p>}
                <button
        ...
        <div className="mt-6 text-center border-t border-[#E0E0E0] pt-5">
          <p className="text-[14px] text-[#424242] font-medium">
            ...
            <Link href="/register" className="text-naturals-green font-bold hover:underline">
              Create one here
            </Link>
          </p>
        </div>
