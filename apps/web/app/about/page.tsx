    ...
    <div className="bg-white min-h-screen text-slate-800">
      ...
      <section className="py-16 md:py-24 container mx-auto px-4 max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-3 mb-6 tracking-tight">
            ...
            <div className="space-y-4 text-slate-600 leading-relaxed text-sm md:text-base">
              ...
              <p>
                At <strong>{BRAND.name}</strong>, we are dedicated to making healthy eating effortless, authentic, and delicious. From pure millet rice and nutrient-dense flours to guilt-free traditional laddus, we bridges the gap between ancient wisdom and contemporary convenience.
              </p>
            </div>
          </div>
      ...
      <section className="bg-slate-50 py-16 border-y border-slate-100">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          <h2 className="text-2xl font-bold text-slate-900 mb-12">The Promises We Live By</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center">
              ...
              <h4 className="font-bold text-slate-800 text-base mb-2">100% Organic</h4>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center">
              ...
              <h4 className="font-bold text-slate-800 text-base mb-2">Minimally Processed</h4>
              <p className="text-slate-500 text-xs leading-relaxed max-w-xs">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center">
              ...
              <h4 className="font-bold text-slate-800 text-base mb-2">Pure Sweeteners</h4>
              <p className="text-slate-500 text-xs leading-relaxed max-w-xs">
      ...
      <section className="py-20 text-center container mx-auto px-4 max-w-3xl">
        ...
        <a 
          href="/product"
          className="inline-flex items-center justify-center font-bold text-sm bg-brand-green text-white hover:bg-emerald-800 px-6 py-3 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg"
        >
