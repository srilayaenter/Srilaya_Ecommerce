...
export const metadata: Metadata = {
  title: "Muesli & Granola Collection â€” Instant Millet Meal Revolution | SriLaYa Naturals",
  description:
    "Shop SriLaYa's ready-to-eat muesli and granola collection â€” 8 varieties including Honey, Chocolate, Strawberry, Nutty, Fruits, Sugar Free, and Stevia Muesli. Whole grain, all natural, no preservatives. Free local delivery in Whitefield, Bangalore.",
};
