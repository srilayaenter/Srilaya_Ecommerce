...
const COLLECTIONS = [
  ...
  },
  {
    ...
    description:
      "Millet-based muesli and granola blends with nuts and seeds. A crunchy, nutritious start to your morning.",
    href: "/category/muesli-and-granola",
    emoji: "🌰",
    accent: "#92400e",
    accentLight: "#FEF3C7",
    badge: "Coming Soon",
    badgeBg: "bg-gray-100 text-gray-500 border-gray-300",
    highlights: ["Nuts & seeds", "No added sugar", "High protein"],
  },
  {
    id: "rice",
    name: "Millet & Traditional Rice",
    tagline: "Rice, reimagined.",
    description:
      "Parboiled millet rice and heritage traditional rice varieties. Softer texture, deeper nutrition, authentic taste.",
    ...
    badge: "Coming Soon",
    badgeBg: "bg-gray-100 text-gray-500 border-gray-300",
    highlights: ["Heritage varieties", "Low GI", "Parboiled options"],
  },
  {
    id: "sweeteners",
