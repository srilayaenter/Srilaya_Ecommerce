...
const V = {
  ...
  COCONUT_JAGGERY_1KG:   "cmrkbo1he004lui4ccbdvl02u",
  ...
  KODO_FLAKES_1KG:       "cmqpkjjyg000iuigkchp2im3z",
};
...
const BUNDLES = [
  ...
  // ── Pack 1 Plus: 2 Adults + 1 Teen ───────────────────────────────────────
  {
    ...
    description:
      "Everything in Basic, plus extra flakes and flour varieties for a growing teenager's appetite. Mixes Foxtail, Little, Ragi, Barnyard, Kodo, and Pearl millet across the pack for better nutrient variety. Approx. 10 kg · 25–30 millet meals/month. Naturally gluten-free.",
    price: 1149,
    items: [
      { variantId: V.FOXTAIL_PARBOILED_1KG, quantity: 2 },
      { variantId: V.LITTLE_PARBOILED_1KG,  quantity: 1 },
      { variantId: V.RAGI_RICE_1KG,         quantity: 1 },
      { variantId: V.FOXTAIL_FLAKES_1KG,    quantity: 1 },
      { variantId: V.KODO_FLAKES_1KG,       quantity: 1 },
      { variantId: V.BARNYARD_RAVA_1KG,     quantity: 1 },
      { variantId: V.PEARL_FLOUR_1KG,       quantity: 1 },
  ...
  // ── Pack 2 Basic: 2 Adults + 2 Kids (6–12 yrs) ──────────────────────────
  {
    ...
    description:
      "Kid-friendly millet kit for school-age children aged 6–12 — mixes Foxtail, Little, Ragi, Barnyard, and Kodo millet for variety and higher flakes proportion for quick weekday breakfasts. No artificial colours, preservatives, or refined flour. Approx. 9 kg · 25 millet meals/month.",
    price: 959,
    items: [
      { variantId: V.FOXTAIL_PARBOILED_1KG, quantity: 2 },
      { variantId: V.LITTLE_PARBOILED_1KG,  quantity: 1 },
  ...
  // ── Pack 2 Plus: 2 Adults + 2 Kids (6–12 yrs) ───────────────────────────
  {
    ...
    description:
      "Everything in Basic, plus an extra flour variety for dosas children love. Approx. 10 kg · 30+ millet meals/month. Naturally gluten-free.",
    price: 1469,
    items: [
      { variantId: V.FOXTAIL_PARBOILED_1KG, quantity: 2 },
      { variantId: V.LITTLE_PARBOILED_1KG,  quantity: 1 },
  ...
  // ── Pack 3 Basic: Couple ─────────────────────────────────────────────────
  {
    ...
    description:
      "Ideal entry pack for working couples starting their millet journey — mixes Foxtail and Ragi millet. Most items cook in under 15 minutes. Approx. 6 kg · 12–15 millet meals/month.",
    price: 615,
    items: [
      { variantId: V.FOXTAIL_PARBOILED_1KG, quantity: 1 },
      { variantId: V.RAGI_RICE_1KG,         quantity: 1 },
      { variantId: V.FOXTAIL_FLAKES_1KG,    quantity: 1 },
      { variantId: V.BARNYARD_RAVA_1KG,     quantity: 1 },
      { variantId: V.FOXTAIL_FLOUR_1KG,     quantity: 1 },
  ...
  // ── Pack 3 Plus: Couple ──────────────────────────────────────────────────
  {
    ...
    description:
      "Everything in Basic, plus extra parboiled rice and a second flour variety for more meal variety. Mixes Foxtail, Little, Ragi, and Barnyard millet. Approx. 9 kg · 18–20 millet meals/month. Naturally gluten-free.",
    price: 915,
    items: [
      { variantId: V.FOXTAIL_PARBOILED_1KG, quantity: 2 },
      { variantId: V.LITTLE_PARBOILED_1KG,  quantity: 1 },
  ...
  // ── Pack 4 Basic: Senior Couple ──────────────────────────────────────────
  {
    ...
    description:
      "Little millet and barnyard millet varieties chosen for their soft, gentle texture when cooked. Sweetened with coconut jaggery powder — no refined sugar. Rich in dietary fibre, magnesium, and potassium. Low glycemic index. Approx. 6.5 kg.",
    price: 939,
    items: [
      { variantId: V.LITTLE_PARBOILED_1KG,  quantity: 1 },
      ...
      { variantId: V.BARNYARD_RAVA_1KG,     quantity: 1 },
      { variantId: V.FOXTAIL_FLOUR_1KG,     quantity: 1 },
      { variantId: V.COCONUT_JAGGERY_1KG,   quantity: 1 },
    ],
  },
  // ── Pack 4 Plus: Senior Couple ───────────────────────────────────────────
  {
    ...
    description:
      "Everything in the Gentle Pack with extra parboiled rice and a second flour variety for a fuller month. No refined sugar in the entire pack. Approx. 8.5 kg. Naturally gluten-free. Suitable as part of a balanced diet.",
    price: 1135,
    items: [
  ...
  // ── Pack 5: Joint Family ─────────────────────────────────────────────────
  {
    ...
    description:
      "Flagship 16 kg monthly millet kit for a joint family of 6 — mixes Foxtail, Little, Ragi, Barnyard, and Kodo millet across the pack instead of a single grain. Covers breakfast, lunch, and dinner. Subscribe monthly for doorstep delivery — Bengaluru-wide. Approx. 50–60 millet-based meals/month. Naturally gluten-free.",
    price: 2165,
    items: [
      { variantId: V.FOXTAIL_PARBOILED_1KG, quantity: 5 },
      { variantId: V.LITTLE_PARBOILED_1KG,  quantity: 2 },
      { variantId: V.RAGI_RICE_1KG,         quantity: 1 },
      { variantId: V.FOXTAIL_FLAKES_1KG,    quantity: 2 },
      { variantId: V.KODO_FLAKES_1KG,       quantity: 1 },
      { variantId: V.BARNYARD_RAVA_1KG,     quantity: 2 },
      { variantId: V.FOXTAIL_FLOUR_1KG,     quantity: 1 },
      { variantId: V.PEARL_FLOUR_1KG,       quantity: 1 },
      { variantId: V.BROWN_SUGAR_1KG,       quantity: 1 },
    ],
